...
import { compressGuideBySlug, compressGuides } from "@/data/compressGuides";
...
const CompressGuide = () => {
  ...
  const guide = compressGuideBySlug[slug];
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Guides", item: "/compress" },
    ...
    <AppLayout>
      ...
      <article className="bg-background">
        <div className="max-w-3xl mx-auto px-6 pt-16 pb-24 md:pt-24 md:pb-32">
          ...
          >
            <Link to="/compress" className="hover:text-primary transition-colors">
              Compress
            </Link>
          ...
          <motion.section {...fadeUp} className="mt-24">
            ...
            >
              ...
              <div className="mt-6 flex items-center justify-center gap-x-4 gap-y-2 flex-wrap text-[11px] text-muted-foreground/60">
                ...
                <span className="text-muted-foreground/30">·</span>
                <Link to="/reduce-file-size" className="hover:text-primary transition-colors">
                  Reduce file size
                </Link>
                <span className="text-muted-foreground/30">·</span>
                <Link to="/compress-email-attachments" className="hover:text-primary transition-colors">
