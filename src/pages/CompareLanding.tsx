...
import {
  compareVariantBySlug,
  type CompareVariantConfig,
  type CompareFeatureRow,
} from "@/data/compareVariants";
...
const CompareLanding = () => {
  ...
  const variant = compareVariantBySlug[slug];
      ...
      <div className="relative bg-background min-h-screen">
        ...
        <div className="max-w-5xl mx-auto px-6 py-20 md:py-28 space-y-20 md:space-y-28">
          ...
          <ComparisonTable
            ...
            rows={variant.features}
            competitor={variant.competitor}
          />

          <ComparisonTable
            title="Compression quality"
            rows={variant.quality}
            competitor={variant.competitor}
          />

          <ComparisonTable
            title="Security & compliance"
            rows={variant.security}
            competitor={variant.competitor}
          />

          <ComparisonTable
            title="Browser experience"
            rows={variant.experience}
            competitor={variant.competitor}
          />

          <ComparisonTable
            title="Supported file types"
            rows={variant.fileSupport}
            competitor={variant.competitor}
          />
          ...
          <motion.section {...fadeUp}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto">
              {Object.values(compareVariantBySlug)
          ...
          <motion.section {...fadeUp}>
            <div className="text-center rounded-3xl p-12 md:p-16 bg-card/40 border border-border/30 backdrop-blur-sm">
              ...
              <p className="text-sm text-muted-foreground/70 mb-8 max-w-md mx-auto">
                Drop a file into Docsora and compare the experience side-by-side.
