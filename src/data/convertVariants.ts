...
const pairVariants: ConvertVariantConfig[] = [
  ...
  buildPair({ slug: "pdf-to-txt", from: "PDF", to: "TXT", icon: "type", accept: ".pdf", uploadLabel: "PDF", acceptedFormats: "PDF", longCopy: "Docsora's PDF to TXT converter extracts clean plain text from any PDF — preserving paragraph order and reading flow. Perfect for content reuse, AI ingestion, and analysis pipelines.", faqQ: "Can I extract text from scanned PDFs?", faqA: "Docsora extracts embedded text directly. For image-only scanned PDFs, OCR is required — available on Docsora Pro." }),
  ...
  buildPair({ slug: "xls-to-pdf", from: "XLS", to: "PDF", icon: "sheet", accept: ".xls", uploadLabel: "XLS spreadsheet", acceptedFormats: "XLS", longCopy: "Docsora's XLS to PDF converter renders legacy Excel XLS spreadsheets into clean PDF documents — multi-sheet support, formula evaluation, and faithful formatting preserved. Built for older Excel file compatibility.", faqQ: "Does it support legacy Excel XLS files?", faqA: "Yes. Docsora handles legacy XLS alongside modern XLSX with consistent output quality and multi-sheet support." }),
  buildPair({ slug: "xlsx-to-pdf", from: "XLSX", to: "PDF", icon: "sheet", accept: ".xlsx", uploadLabel: "XLSX spreadsheet", acceptedFormats: "XLSX", longCopy: "Docsora's XLSX to PDF converter renders modern Excel spreadsheets into professional PDFs — multi-sheet support, conditional formatting, and table styling preserved exactly.", faqQ: "Are multi-sheet XLSX workbooks supported?", faqA: "Yes — every sheet is paginated cleanly into the output PDF preserving structure, formatting, and evaluated formula values." }),
  ...
  buildPair({ slug: "ppt-to-pdf", from: "PPT", to: "PDF", icon: "slides", accept: ".ppt", uploadLabel: "PPT presentation", acceptedFormats: "PPT", longCopy: "Docsora's PPT to PDF converter renders legacy PowerPoint presentations into pixel-accurate PDFs — slide layouts, fonts, embedded media, and master templates preserved. Compatible with older PowerPoint versions.", faqQ: "Does it support legacy PPT files?", faqA: "Yes. Docsora handles legacy PPT alongside modern PPTX with consistent slide quality and layout preservation." }),
  buildPair({ slug: "pptx-to-pdf", from: "PPTX", to: "PDF", icon: "slides", accept: ".pptx", uploadLabel: "PPTX presentation", acceptedFormats: "PPTX", longCopy: "Docsora's PPTX to PDF converter renders modern PowerPoint decks into share-ready PDFs — slide layouts, fonts, embedded images, charts, and master templates preserved. Built for investor decks, sales presentations, and training material.", faqQ: "Will slide quality be preserved?", faqA: "Yes. Slide layouts, fonts, and embedded media are preserved so output PDFs look identical to your PPTX deck." }),
