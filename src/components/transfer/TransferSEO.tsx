      ...
      <div className="max-w-6xl mx-auto px-6 py-24 md:py-32 space-y-28 md:space-y-36">
        ...
        <section>
          <motion.div {...fadeUp} className="text-center mb-14 max-w-2xl mx-auto">
            ...
            <p className="text-sm text-muted-foreground/80 leading-relaxed">Docsora Transfer helps teams and individuals send large files securely, track downloads, manage transfer expiry dates over a range of different file types. Here are some of the accepted file types you can send using Docsora Transfer:</p>
          </motion.div>
