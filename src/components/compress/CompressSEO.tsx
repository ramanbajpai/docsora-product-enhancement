...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Absolutely - Docsora is a complete browser-based image compressor for JPG, JPEG, PNG, GIF, BMP, TIFF, and WEBP files, individually or in bulk. Perceptual encoding balances dimensions, color depth, and quality so photos and graphics stay visually identical while image size drops 30–80%. Use it to reduce image size for websites, blog posts, social media, marketing assets, and product catalogs.",
  },
  {
          ...
          >
            ...
            <div className="relative">
              <h2 className="text-2xl md:text-[1.875rem] font-semibold text-foreground tracking-tight mb-4 leading-tight">
                ...
                <span className="text-foreground/70"> for every file type.</span>
              </h2>
              <p className="text-[14px] md:text-[15px] text-muted-foreground/80 mb-10 max-w-lg mx-auto leading-relaxed">
                Format-aware compression for documents, decks, spreadsheets,
                and media — built for operational teams and modern delivery.
              </p>
              <motion.button
                onClick={scrollToTop}
                whileHover={{ y: -1 }}
