          ...
          >
            ...
            <div className="relative">
              <h2 className="text-2xl md:text-[1.875rem] font-semibold text-foreground tracking-tight mb-4 leading-tight">
                Modern file conversion workflows
                <br className="hidden sm:block" />
                <span className="text-foreground/70"> for every format.</span>
              </h2>
              <p className="text-[14px] md:text-[15px] text-muted-foreground/80 mb-10 max-w-lg mx-auto leading-relaxed">
                Format-aware conversion for PDFs, documents, spreadsheets,
                presentations, images, and email — built for operational teams and modern delivery.
              </p>
              <motion.button
                onClick={scrollToTop}
                whileHover={{ y: -1 }}
